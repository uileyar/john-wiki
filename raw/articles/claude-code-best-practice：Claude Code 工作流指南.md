...
source: https://mp.weixin.qq.com/s/X-r1cLYRGZk0aXkW9SVk4w
author:
  - "[[wsleepybear]]"
published:
created: 2026-04-19
description: 是一份讲清 Claude Code 工作流分工的实战指南：command、skill、agent、settings、memory、MCP 该放什么、怎么配合。
tags:
  - clippings
---
wsleepybear *2026年3月17日 17:00*
...
![Claude Code 三层结构示意图](https://mmbiz.qpic.cn/sz_mmbiz_png/ghX7kZbxMnb0fchcsiccoIh4ZrBzrIZqAWiaiaHYbMvBeJskl4KMcRIFHtoVJPe5AoCyWl4IElMuBQxuS10CR3Vgbnv648pIqwLR1s2lqRILqU/640?from=appmsg&watermark=1&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0 "Claude Code 三层结构示意图")
